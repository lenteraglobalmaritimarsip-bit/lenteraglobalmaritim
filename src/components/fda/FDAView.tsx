        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl p-6">
            ...
            <form onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); handleAddActualCost(); }} className="space-y-3 text-xs">
              ...
              <div><label className="text-slate-400 block mb-1">Category:</label><select value={newActual.category} onChange={e=>setNewActual({...newActual,category:e.target.value})} className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2 text-white"><option value="PORT_DUES">Port Expenses</option><option value="AGENCY_FEE">Agency Fee</option><option value="COST_EPDA">Cost EPDA</option><option value="COST_FDA">Cost FDA</option><option value="VAT_11">VAT 11%</option><option value="PPH_INCOME_TAX">PPH / Income Tax</option></select></div>
